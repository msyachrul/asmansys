                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                            	...
                            	<a class="btn btn-secondary rounded pull-right" href="{{ route('certificate.create') }}"><i class="fa fa-plus"></i> Create New</a>	
                            </div>
                        </div>
                        <div class="card-body">
                              ...
                              <table id="table-certificate" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                	...
                                	<tr>
                                        ...
                                        <td class="btn-group">
                                            <a class="btn btn-secondary btn-sm rounded btn-detail" href="{{ route('certificate.show',$value->id) }}">Detail</a>
                                		</td>
                                	</tr>
                                	@endforeach
                                </tbody>
