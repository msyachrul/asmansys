                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                            	...
                            	<a class="btn btn-secondary pull-right" href="{{ route('region.create') }}"><i class="fa fa-plus"></i> Create New</a>	
                            </div>
                        </div>
                        <div class="card-body">
                              ...
                              <table id="table-region" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                	...
                                	<tr>
                                		...
                                		<td>{{ $value->name }}</td>
                                        <td class="btn-group">
                                            <a class="btn btn-secondary btn-detail" href="{{ route('region.show',$value->id) }}">Detail</a>
                                		</td>
                                	</tr>
                                	@endforeach
                                </tbody>
