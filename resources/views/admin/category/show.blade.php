                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <span style="font-size:24px">Category Detail</span>
                                <div class="btn-group pull-right">
                                    ...
                                    <form id="remove-form" action="{{ route('category.destroy',$value->id) }}" method="post" style="display: none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
                        ...
                        <div class="card-body">
                            <form id="update-form" action="{{ route('category.update',$value->id) }}" method="post" style="max-width:70%;margin:auto">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group btn-process">
                                    <a href="{{ route('category.index') }}" class="btn btn-secondary form-control">Close</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('extraScript')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click','.btn-cancel', function () {
            ...
            $('.btn-process').html('<a href="{{ route('category.index') }}" class="btn btn-secondary form-control">Close</a>');
        });
